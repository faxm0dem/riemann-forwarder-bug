...
puppet docker dockerfile --image-name riemann-fw-bug/collectd_tg --entrypoint /usr/local/bin/dumb-init,-- --expose 5556:5556 --cmd collectd-tg > Dockerfile-collectd_tg
```
